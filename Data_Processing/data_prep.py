...
def data_prep(u_data, hour_diff, w_data, export_name):
    ...
    export_name - string; the output file name after the data is processed and to be stored on local drive as a csv file
    ...
    model_prep.to_csv('{}.csv'.format(export_name))